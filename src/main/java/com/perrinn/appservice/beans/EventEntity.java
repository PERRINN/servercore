...
public class EventEntity {
    ...
    private byte active;
    private Timestamp evtStart;
    private Timestamp evtEnd;
    ...
    public void setEvtStart(Timestamp evtStart) {
        this.evtStart = evtStart;
    }

    public Timestamp getEvtEnd() {
        return evtEnd;
    }

    public void setEvtEnd(Timestamp evtEnd) {
        this.evtEnd = evtEnd;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (evtStart != null ? !evtStart.equals(that.evtStart) : that.evtStart != null) return false;
        if (evtEnd != null ? !evtEnd.equals(that.evtEnd) : that.evtEnd != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (evtStart != null ? evtStart.hashCode() : 0);
        result = 31 * result + (evtEnd != null ? evtEnd.hashCode() : 0);
